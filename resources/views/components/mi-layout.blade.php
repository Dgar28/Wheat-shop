...
<body>
                        ...
                        <div class="dropdown-menu dropdown-menu-end bg-secondary border-0 rounded-0 rounded-bottom m-0">
                            <a href="#" class="dropdown-item">
                                <div class="d-flex align-items-center">
                                    <img class="rounded-circle" src="{{ asset('styles/img/user.jpg') }}" alt="" style="width: 40px; height: 40px;">
                                    <div class="ms-2">
    ...
    <script src="{{ asset('styles/lib/chart/chart.min.js') }}"></script>
    ...
    <script src="{{ asset('styles/lib/tempusdominus/js/moment.min.js') }}"></script>
    <script src="{{ asset('styles/lib/tempusdominus/js/moment-timezone.min.js') }}"></script>
    <script src="{{ asset('styles/lib/tempusdominus/js/tempusdominus-bootstrap-4.min.js') }}"></script>
